...
class ImageViewPagerStadiumAdapter(private val ctx: Context, var mArrayUri: ArrayList<String>) :
    PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        Picasso.get().load(Utils.host+"/imageStadium/"+mArrayUri[position]).into(imageView)
